...
export type TranslationKey =
  ...
  | 'mail.supplement.insured'
  | 'mail.supplement.package-value'
  | 'sender'
  | 'receiver'
  | 'region.select'
  | 'region.mainland'
...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  'en': {
    ...
    'mail.supplement.insured': 'Insured',
    'mail.supplement.package-value': 'Package Value',
    'sender': 'From',
    'receiver': 'To',
    ...
    'calculation.rule-discount': 'Discounts for Specific Customers',
  ...
  'zh-TW': {
    ...
    'calculation.rule-discount': '特定人群優惠',
    'calculation.stamp-discount': '郵品折扣',
  ...
  'zh-CN': {
    ...
    'calculation.rule-discount': '特定人群优惠',
    'calculation.stamp-discount': '邮品折扣',
